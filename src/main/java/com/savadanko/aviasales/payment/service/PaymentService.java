...
public class PaymentService {
    ...
    public PaymentProcessResponse processPayment(PaymentProcessRequest request) {
        ...
        if (gatewayResult.isSuccess()) {
            ...
            String userEmail = booking.getContactInfo() != null ? booking.getContactInfo().getEmail() : null;
    ...
    private boolean isPaymentWindowExpired(BookingEntity booking, Instant now) {
        ...
        Instant deadline = createdAt.plus(paymentsProperties.getBookingPaymentTtl());
